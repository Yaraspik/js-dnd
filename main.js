...
/* harmony import */ var _Task__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./Task */ "./src/js/Task.js");
...
var Kanban = /*#__PURE__*/function () {
  ...
  _createClass(Kanban, [{
    ...
    value: function init() {
      var _this = this;
      this.btnOpenControlsCreateTask.forEach(function (el) {
        return el.addEventListener('click', _this.openControlsCreateTask);
      });
      this.loadData();
      this.drawTaskList();
      this.moveInit();
    ...
    key: "createTask",
    value: function createTask(text, columnName) {
      return _Task__WEBPACK_IMPORTED_MODULE_20__["default"].createTaskElement(text, columnName, this);
    }
  }, {
    key: "drawTaskList",
    value: function drawTaskList() {
      var _this2 = this;
      var _loop = function _loop(key) {
        if (Object.hasOwnProperty.call(_this2.data, key)) {
          var elements = _this2.data[key];
          var curColumn = Array.from(_this2.columns).find(function (el) {
            return el.dataset.name === key;
          });
          var taskList = curColumn.querySelector('.task-list');
          Array.from(taskList.children).forEach(function (el) {
            return el.remove();
          });
          elements.forEach(function (el) {
            taskList.append(_this2.createTask(el, key));
          });
        }
      };
    ...
    key: "drawNewTask",
    value: function drawNewTask(columnName, task) {
      var curColumn = Array.from(this.columns).find(function (el) {
        return el.dataset.name === columnName;
      });
      var taskList = curColumn.querySelector('.task-list');
    ...
    key: "moveAt",
    value: function moveAt(pageX, pageY) {
    ...
    value: function onMouseUp() {
      ...
      var clone = this.taskClone;
      var initialColumnName = this.actualTask.initialColumnName;
      this.taskClone.classList.remove('clone');
      this.actualTask.remove();
      this.actualTask = this.taskClone;
      this.taskClone = null;
      var columnName = this.activeColumn.dataset.name;
      var textActualTask = this.actualTask.querySelector('.task-content').textContent;
      var indexUpMouse = this.data[columnName].length;
      if (clone.nextSibling) {
        var nextElText = clone.nextSibling.querySelector('.task-content').textContent;
        indexUpMouse = this.data[columnName].findIndex(function (el) {
          return el === nextElText;
        });
      }
      var indexActiveTask = this.data[initialColumnName].findIndex(function (el) {
        return el === textActualTask;
      });
    ...
    value: function onMouseMove(e) {
      ...
      var _activeColumn = e.target.closest('.column');
      if (!_activeColumn) return;
      this.activeColumn = _activeColumn;
      var taskList = _activeColumn.querySelector('.task-list');
      var mouseTask = e.target.closest('.task');
      ...
      var verticalTaskCenter = mouseTask.getBoundingClientRect().top + mouseTask.getBoundingClientRect().height / 2;
    ...
    key: "openControlsCreateTask",
    value: function openControlsCreateTask(e) {
    ...
    key: "cancelTaskCreate",
    value: function cancelTaskCreate() {
      var activeColumn = this.activeColumn;
    ...
    value: function addNewTask() {
      var activeColumn = this.activeColumn;
      var columnName = activeColumn.column.dataset.name;
      var task = this.createTask(this.activeColumn.textarea.value, columnName);
      activeColumn.btnOpenControls.classList.remove('hide');
      activeColumn.controls.classList.add('hide');
...
var Task = /*#__PURE__*/function () {
  ...
  _createClass(Task, null, [{
    ...
    value: function createTaskElement(text, columnName, kanban) {
      ...
      removeEl.addEventListener('click', function () {
        task.remove();
        kanban.data[columnName].find(function (el, index) {
          if (el === content) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Kanban__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Kanban */ "./src/js/Kanban.js");

var kanbanElement = document.querySelector('.kanban');
var kanban = new _Kanban__WEBPACK_IMPORTED_MODULE_0__["default"](kanbanElement);
kanban.init();
